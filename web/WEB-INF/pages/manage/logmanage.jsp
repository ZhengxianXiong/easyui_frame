                ...
                <div class="screen-top">
                    <div class="colRow">
                        <input id="txtNewPass" type="text" class="easyui-textbox" name="name"
                               data-options="label:'操作人/部门'"/>
                    </div>
                    <div class="colRow">
                        <select class="easyui-combobox" name="state" data-options="label:'操作类型:',required:true"
                                labelPosition="top" style="width:100%;">
                            <option value="AL">全部</option>
                            <option value="AK">修改</option>
                            <option value="AK">录入</option>
                        </select>
                    </div>
                    <div class="colRow">

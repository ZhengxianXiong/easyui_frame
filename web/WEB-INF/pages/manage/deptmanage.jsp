                ...
                <div class="form-column2">
                    <div class="form-column-left">
                        <input class="easyui-textbox" name="wznumber" style="width:100%"
                               data-options="label:'部门识别代码:',required:true">
                    </div>
                    <div class="form-column-left fm-left">
                        <select class="easyui-combobox" name="state" data-options="label:'部门类型:',required:true"
                                labelPosition="top" style="width:100%;">
                            <option value="AL">部门类型1</option>
                            <option value="AK">部门类型2</option>
                        </select>
                    </div>
                </div>
                <div class="form-column2">
                    <div class="form-column-left">
                        <select class="easyui-combobox" name="state" data-options="label:'部门级别:',required:true"
                                labelPosition="top" style="width:100%;">
                            <option value="AL">市局</option>
                            <option value="AK">大队</option>
                        </select>
                    </div>
                    <div class="form-column-left fm-left">
                        <select class="easyui-combobox" name="state" data-options="label:'所属区划:',required:true"
                                labelPosition="top" style="width:100%;">
                            <option value="AL">市本级</option>
                        </select>
                    </div>
                </div>
                <%--<div class="form-column2">--%>
                ...
                <div class="screen-top">
                    <div class="colRow">
                        <input id="txtNewPass" type="text" class="easyui-textbox" name="name"
                               data-options="label:'部门名称'"/>
                    </div>
                    <div class="colRow">
                        <%--<input id="numbers" type="text" class="easyui-combobox" name="name" data-options="label:'所属部门'" />--%>
                        <select class="easyui-combobox" name="state" data-options="label:'所属部门:',required:true"
                                labelPosition="top" style="width:100%;">
                            <option value="AL">宁波城管</option>
                            <option value="AK">海曙区局</option>
                        </select>
                    </div>
                    <div class="colRow">
                        <%--<input type="text" id="selest-item" name="" class="easyui-combobox" name="language" label="用户状态" />--%>

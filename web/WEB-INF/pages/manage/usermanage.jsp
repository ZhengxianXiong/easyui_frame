        ...
        <div class="tabs-wrapper">
                ...
                <div class="screen-top">
                    <div class="colRow">
                        <input id="txtNewPass" type="text" class="easyui-textbox" name="name"
                               data-options="label:'用户'"/>
                    </div>
                    <div class="colRow">
                        <input id="numbers" type="text" class="easyui-textbox" name="name" data-options="label:'用户名称'"/>
                    </div>
                    <div class="colRow">
            ...
            <table class="table table-fixed table-dotted table-hover">
                ...
                <tr>
                    ...
                    <td>超级管理员</td>
                    <td>宁波城管</td>
                    <td>超级管理员,中队录入人员,中队办案人员,对账查询</td>
                    <td>有效</td>
                    <td>2019-04-22 14:38</td>
                    <td class="updateBtn">

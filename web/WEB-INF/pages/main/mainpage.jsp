...
<head id="Head1">
    ...
    <link rel="Bookmark" href="${contextPath}/include/assets/default/images/logoIco.ico"/>
    <link rel="Shortcut Icon" href="${contextPath}/include/assets/default/images/logoIco.ico"/>
...
<noscript>
    <div class="bowerPrompt" class="bowerPrompt">
        <img src="${contextPath}/include/assets/images/noscript.gif" alt='抱歉，请开启脚本支持！'/>
    </div>
</noscript>
<!-- 头部 -->
...
<div data-options="region:'south',split:false,border:false" class="copyright">
    <div class="footer">
        <span class="pull-left"> 维护Q群：149663025，维护邮箱：<a
                href="mailto:djcbpl@163.com?subject=咨询：body=源地址：">djcbpl@163.com</a>  &copy; Copyright ©2016 ~ <font
                id="timeYear">2019</font></span>
...
<!--修改密码窗口-->
<div data-options="collapsible:false,minimizable:false,maximizable:false" id="updatePwd" class="easyui-window updatePwd"
     title="修改密码">
    <div class="row">
...
<script src='${contextPath}/include/assets/js/index2.js' type="text/javascript"></script>
<script src='${contextPath}/include/assets/js/system.menu2.js' type="text/javascript"></script>

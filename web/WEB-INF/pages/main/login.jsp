...
<head>
    ...
    <link rel="Bookmark" href="${contextPath}/include/assets/images/logoIco.ico"/>
    <link rel="Shortcut Icon" href="${contextPath}/include/assets/images/logoIco.ico"/>
    <link type="text/css" rel="stylesheet" href="${contextPath}/include/assets/default/login/css/login.css">
</head>
<body>
...
<form id="loginForm" name="loginForm" action="${contextPath}/main" class="fm-v clearfix" method="post">
    ...
    <div class="ordinaryLogin">
        <div class="login_ad">
            <div class="bg_ordLogin"><img src="${contextPath}/include/assets/default/login/images/icon-banner.png"/>
            </div>
                    ...
                    <div class="login_text">
                        ...
                        <div class="user_parent">
                            <div class="login_input user_bg unm">
                                <input name="username" id="username" tabindex="1" value="" type="text"
                                       class="usernameSty"
                                <%--onblur="if(this.value==&#39;&#39;) {this.value=&#39;邮箱／手机号&#39;;this.style.color=&#39;#999&#39;}"--%>
                                <%--onfocus="if(this.value==&#39;邮箱／手机号&#39;) this.value=&#39;&#39;;this.style.color=&#39;#222&#39;"--%>
                                       autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="user_paswd">
                            <div class="login_input user_bg pwd" name="pwdParent" id="pwdParent">
                                <div id="newPwd" class="keyboards-box">
                                    <input id="keyboards" value="" type="password" name="keyboards" tabindex="3"
                                           pa_ui_name="keyboard" pa_ui_keyboard_position="place"
                                           pa_ui_key_type="advance" class="styTextinput w162px" maxlength="20">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="user_code">
                            <div class="login_input user_bg vnc">
                                <input name="verification" id="verification" tabindex="1" value="验证码" type="text"
                                       class="usernameSty"
                                       onblur="if(this.value==&#39;&#39;) {this.value=&#39;验证码&#39;;this.style.color=&#39;#999&#39;}"
                                       onfocus="if(this.value==&#39;验证码&#39;) this.value=&#39;&#39;;this.style.color=&#39;#222&#39;"
                                       autocomplete="off">
...
<div class="footBorder_t01">
    <div class="ce_about_foot">
        <p class="ce_about_copyright">
            <a href="javascript:;">汇智提供技术支持</a>
            <span class="">|</span>
            <a href="https://shop155629335.taobao.com/?spm=a230r.7195193.1997079397.2.diL9ud">汇智</a>
            <span class="">|</span>
            <a href="javascript:;">联系邮箱：djcbpl@163.com</a>
        </p>
        <!-- <span class="esc"><img src="assets/login/images/logo-1sc.png" /></span> -->
        <span class="" style="">汇智版权所有.&nbsp;</span>
...
<!-- <script src="assets/login/js/jquery-ui.min.js" type="text/javascript"></script>
<script src="assets/login/js/pa_ui.js" type="text/javascript"></script>
<script src="assets/login/js/pa_ui_misc.js" type="text/javascript"></script> -->

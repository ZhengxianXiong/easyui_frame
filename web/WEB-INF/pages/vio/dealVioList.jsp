        ...
        <div class="tabs-wrapper">
            <div class="comp-search-box">
                <div class="screen-top">
                    <div class="colRow">
                        <input id="txtbillno" type="text" class="easyui-textbox" name="name"
                               data-options="label:'抄告单号：'"/>
                    </div>
                    <div class="colRow">
            ...
            <table class="table table-fixed table-dotted table-hover">
                ...
                <tr>
                    ...
                    <td>未结案</td>
                    <td>
                        <a href="javascript:;" title="" class="info">处理</a>
                        <%--<a href="javascript:;" title="修改" onclick="newQkialog()" class="info"><i class="fa fa-pencil-square-o"></i></a>--%>

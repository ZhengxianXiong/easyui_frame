    ...
    <div class="table-container">
        <div class="tabs-wrapper">
            ...
            <div class="btnbar-tools">
                <a href="javascript:;" class="edit" id="edit"><i class="fa fa-pencil-square info"></i>修改</a>
                <a href="javascript:;" class="del" id="del"><i class="fa fa-times-rectangle danger"></i>删除</a>
                <a href="javascript:;" class="check" id="check"><i class="fa fa-check-circle yellow"></i>审核</a>
            </div>
        ...
        <form id="vui_sample" class="easyui-form" method="post" data-options="novalidate:true">
            <div class="form-column2">
                <div class="form-column-left">
                    <input class="easyui-textbox" name="name" value="浙BN398C" style="width:100%"
            ...
            <div class="form-column2">
                <div class="form-column-left">
                    <input class="easyui-textbox" id="storage-wfsj2" value="2019-04-22 14:12" name="subject"
                           style="width:100%" data-options="label:'违法时间:',required:true">
                </div>
                <div class="form-column-left fm-left">
                    <input class="easyui-textbox" name="subject" value="测试道路1" style="width:100%"
                           data-options="label:'违法道路:',required:true">
                </div>
            </div>
            <div class="form-column2">
                <div class="form-column-left">
                ...
                <div class="form-column-left fm-left">
                    <input class="easyui-textbox" name="subject" value="248#" style="width:100%"
                           data-options="label:'详细地址:',required:true">
                </div>
            </div>
            <div class="form-column2">
                <div class="form-column-left">
                    <input class="easyui-textbox" name="sqkf" value="陆某某" style="width:100%"
                           data-options="label:'采集民警1:',required:true">
                </div>
                <div class="form-column-left fm-left">
                    <input class="easyui-textbox" name="subject" value="熊某木" style="width:100%"
                           data-options="label:'采集民警2:',required:true,validType:'number'">
                </div>
            </div>

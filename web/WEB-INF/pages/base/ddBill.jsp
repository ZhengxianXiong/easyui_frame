    ...
    <div class="col-md-12">
        <div class="easyui-panel" title="告知单入库" style="width:100%;max-width:400px;padding:30px 60px;">
            <form id="vui_sample" class="easyui-form" method="post" data-options="novalidate:true">
                ...
                <div style="margin-bottom:20px">
                    <select class="easyui-combobox" name="state" data-options="label:'领用部门:',required:true"
                            style="width:100%;">
                        <option value="">请选择领用部门</option>
                        <option value="">鄞州区行政执法局</option>
                        <option value="">海曙区行政执法局</option>
                        <option value="">江北区行政执法局</option>
                        <option value="">慈溪市行政执法局</option>
                        <option value="">奉化市行政执法局</option>
                        <option value="">象山县行政执法局</option>
                        <option value="">余姚市市行政执法局</option>
                        <option value="">北仑区市行政执法局</option>
                        <option value="">镇海区行政执法局</option>
                    </select>
                </div>
                <div style="margin-bottom:20px">
            ...
            <div class="form-btnBar pl75">
                <input type="submit" name="" value="下发" class="easyui-linkbutton btnPrimary" onclick="submitForm()"/>

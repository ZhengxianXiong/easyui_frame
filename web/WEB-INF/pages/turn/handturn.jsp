                ...
                <div class="screen-top">
                    ...
                    <div class="colRow">
                        <select class="easyui-combobox" name="state" data-options="label:'号牌种类:',required:true"
                            ...
                            <option value="AK">小型车</option>
                            <option value="AK">大型车</option>
                        </select>
                    </div>
                    <div class="colRow">
                        ...
                        至
                        <input id="txtNewPass4" type="text" class="easyui-textbox" name="name"/>
                    </div>
                    <div class="colRow">
            ...
            <table class="table table-fixed table-dotted table-hover">
                ...
                <tr>
                    ...
                    <td class="updateBtn">
                        ...
                        <a href="javascript:;" title="删除" class="danger delMsg"><i class=""></i></a>
                    </td>
                </tr>
                <tr>
                    <td class="center">
